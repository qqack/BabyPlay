 ...
 */
public class Activity_math extends Activity implements GestureDetector.OnGestureListener ,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater factory = LayoutInflater.from(Activity_math.this);
        View first = factory.inflate(R.layout.math_1, null);
        View second = factory.inflate(R.layout.math_2, null);
        View third = factory.inflate(R.layout.math_3, null);
