...
public class Activity_test extends Activity {
    ...
    private int x;
    private static int[] s1=new int[]{R.mipmap.cat,R.mipmap.pingguo,R.mipmap.xiangjiao,R.mipmap.cattle,R.mipmap.dog,R.mipmap.juzi,R.mipmap.plane,R.mipmap.bus,R.mipmap.math_1,R.mipmap.math_2,R.mipmap.square,R.mipmap.triangle,R.mipmap.pink,R.mipmap.red};
                ...
                if(s1[0]==s1[x])
                    {
                        ...
                        Intent intent=new Intent(Activity_test.this,Activity_test2.class);
