 ...
 */
public class Activity_shape extends Activity implements GestureDetector.OnGestureListener ,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater factory = LayoutInflater.from(Activity_shape.this);
        View first = factory.inflate(R.layout.shape_square, null);
        View second = factory.inflate(R.layout.shape_oblong, null);
        View third = factory.inflate(R.layout.shape_triangle,null);
