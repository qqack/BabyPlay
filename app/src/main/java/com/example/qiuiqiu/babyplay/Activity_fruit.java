 ...
 */
public class Activity_fruit extends Activity implements GestureDetector.OnGestureListener ,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater factory = LayoutInflater.from(Activity_fruit.this);
        View first = factory.inflate(R.layout.fruit_lizi, null);
        View second = factory.inflate(R.layout.fruit_pingguo, null);
        View third = factory.inflate(R.layout.fruit_xiangjiao, null);
        View four = factory.inflate(R.layout.fruit_juzi, null);
        View five = factory.inflate(R.layout.fruit_taozi, null);
