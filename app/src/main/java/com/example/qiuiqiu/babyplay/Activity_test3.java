...
public class Activity_test3 extends Activity {
    ...
    private void getDiolog(){
        android.content.DialogInterface.OnClickListener listener_yes = new android.content.DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Activity_test3.this, Activity_test.class);
                startActivity(intent);
            }
        };
        android.content.DialogInterface.OnClickListener listener_no = new android.content.DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_test3.this);
        builder.setTitle("太棒了，还要再来一次吗？");
        builder.setPositiveButton("确定",listener_yes);
        builder.setNegativeButton("取消",listener_no);
        builder.show();
    }
}
