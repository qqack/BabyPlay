 ...
 */
public class Activity_trans extends Activity implements GestureDetector.OnGestureListener ,View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater factory = LayoutInflater.from(Activity_trans.this);
        View first = factory.inflate(R.layout.trans_cycle, null);
        View second = factory.inflate(R.layout.trans_plane, null);
        View third = factory.inflate(R.layout.trans_train, null);
